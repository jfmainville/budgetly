...
describe('transactionActions', () => {
    ...
    it('should execute the createTransactionRowSuccess action', () => {
        ...
        expect(actions.createTransactionRowSuccess(rowId, transactionId)).toEqual(expectedAction)
    });
    ...
    it('should execute the deleteTransactionRowSuccess action', () => {
        ...
        expect(actions.deleteTransactionRowSuccess(rowId, transactionId)).toEqual(expectedAction)
    });
});
