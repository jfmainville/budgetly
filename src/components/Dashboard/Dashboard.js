...
const dashboard = () => {
    const monthlyIncomesExpensesData = {
        ...
        datasets: [
            {
                label: "Incomes",
                data: [1000, 1200, 1500, 1500, 1000, 2000, 1300, 1200, 1100, 1033, 1200, 1300],
                backgroundColor: "#29a529",
            },
            {
                label: "Expenses",
                data: [1000, 1200, 700, 700, 1000, 1200, 1300, 1200, 1100, 1000, 1400, 1500],
    ...
    const categoryExpensesData = {
        labels: ["Automobile", "Grocery", "Housing", "Entertainment", "Activity", "Sport"],
        datasets: [
            {
                label: ["Expenses"],
